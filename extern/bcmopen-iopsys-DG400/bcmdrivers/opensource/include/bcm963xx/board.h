...
#define BOARD_IOCTL_SPI_INIT                    _IOWR(BOARD_IOCTL_MAGIC, 127, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SPI_WRITE                   _IOWR(BOARD_IOCTL_MAGIC, 128, BOARD_IOCTL_PARMS)
...
#define BOARD_IOCTL_NVRAM_WRITE                 _IOWR(BOARD_IOCTL_MAGIC, 63, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_SERIAL_NUMBER           _IOWR(BOARD_IOCTL_MAGIC, 64, BOARD_IOCTL_PARMS)  
...
extern int updateDefaultNvram(void);
...
extern void inteno_netlink_string(const char *s);
extern void inteno_netlink_linkscan(char * port_name, int state);
extern void inteno_netlink_dsl(char * msg);
extern int kerSysGetSerialnum( char *serialnumber );
extern int kerSysGetBaseMacAddr(unsigned char * basemacaddr);
extern int kerSysGetImageVersion(int imageNumber,char * verStr,int verStrSize);
...
extern int kerSysGetHwVer(char *string);
