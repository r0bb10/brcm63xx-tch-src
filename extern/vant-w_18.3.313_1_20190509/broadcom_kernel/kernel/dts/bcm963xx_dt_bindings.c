...
#define TCH_RESERVED_DEF_SIZE     0x40000
#define DRAM_OFFSET_TCH_RESERVED  (DRAM_BASE+DRAM_DEF_SIZE-TCH_RESERVED_DEF_SIZE)

#define	DRAM_BASE_END     (DRAM_BASE+DRAM_DEF_SIZE-MBALIGN(TCH_RESERVED_DEF_SIZE))
...
build_clause(#define,"TCH_RESERVED_DEF_SIZE",TCH_RESERVED_DEF_SIZE)
build_clause(#define,"DRAM_OFFSET_TCH_RESERVED",DRAM_OFFSET_TCH_RESERVED)
